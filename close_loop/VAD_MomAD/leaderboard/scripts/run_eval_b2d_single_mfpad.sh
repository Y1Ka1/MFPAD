...
CKPT_PATH="${CKPT_PATH:-/path/to/mfpad_ckpt.pth}"
...
SAVE_PATH="${SAVE_PATH:-${ROOT}/leaderboard/eval_bench2drive220_mfpad_${ALGO}_${PLANNER_TYPE}}"
CHECKPOINT_DIR="${ROOT}/leaderboard/${ALGO}_b2d_${PLANNER_TYPE}"
CHECKPOINT_ENDPOINT="${CHECKPOINT_ENDPOINT:-${CHECKPOINT_DIR}/mfpad_single.json}"
