...
class NuScenes3DDataset_roboAD_12s(NuScenes3DDataset_roboAD_6s):
    def evaluate(
        self,
        results,
        eval_mode,
        ...
        if eval_mode["with_planning"]:
            from .evaluation.planning.planning_eval_roboAD_12s import planning_eval_roboAD_12s
            planning_results_dict = planning_eval_roboAD_12s(results, self.eval_config, logger=logger)
            results_dict.update(planning_results_dict)
        ...
        if "avg_l2_7_12" in results_dict:
            metric_str += f'avg_l2_7_12: {results_dict["avg_l2_7_12"]:.4f}\n'
            metric_str += f'avg_collision_7_12: {results_dict["avg_collision_7_12"]:.4f}\n'
            metric_str += f'rel_l2_6_to_12_pct: {results_dict["rel_l2_6_to_12_pct"]:.2f}\n'
            metric_str += f'rel_collision_6_to_12_pct: {results_dict["rel_collision_6_to_12_pct"]:.2f}\n\n'
